...
// Constructor
//---------------------------
MapGenerator::MapGenerator(string name, string MapType)
:	name_(name),
	MapType_("Empty"),
...
// Public
//---------------------------
void MapGenerator::SetSample(double constant, double x, double y, double z)
{
	if(MapType_=="2D") z=0;
...
void MapGenerator::SetSigma(double sigma)
{
	sigma_ = sigma;
}

double MapGenerator::GetConstant(double x, double y, double z)
{
	if(MapType_=="2D") z=0;
	...
	/*
	// debug
	cout<<"MapGenerator::GetConstant"<<endl;
...
// Public
//---------------------------
void MapGenerator::GetMap(int binx, double minx, double maxx,int biny, double miny, double maxy,int binz, double minz, double maxz)
{
	if(MapType_=="2D") {
		binz = 1;
		minz = 0;
...
// Private
//---------------------------
double MapGenerator::GaussianFunction(double mu, double sigma, double value)
{
