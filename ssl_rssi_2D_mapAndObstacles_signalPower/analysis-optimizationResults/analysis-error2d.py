...
# heatmap
sns_plot = sns.heatmap(pt, linewidths = 0.00, ax = ax[0], cmap=cmap, xticklabels=8, yticklabels=8)
sns_plot = sns.heatmap(pt, linewidths = 0.00, ax = ax[1], cmap=cmap, xticklabels=8, yticklabels=8)
...
ax[1].text(left, bottom, r"(a) $P_{Th} \to 0 dBm$", fontsize=14,horizontalalignment='left',verticalalignment='top',transform=ax[1].transAxes)
