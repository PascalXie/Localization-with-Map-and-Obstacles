...
#
analyzeError("log_error_noise_InftyWeight.txt")
analyzeError("log_error_noise.txt")
...
plt.errorbar(situations_sampleSigma[1],situations_list_Error[1],yerr=situations_list_StdDev[1],fmt='ks--',ecolor='m',elinewidth=1.5,ms=5,mfc='wheat',mec='salmon',capsize=3,label='$P_{Th}=-20 dBm$')
...
plt.legend()
plt.savefig('figure-Error-Noise.png',dpi=300)
plt.show()
